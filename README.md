...
skills/verdict  planned: SKILL.md, references per command, installer script (not on this branch)
docs            planned: design notes and the builder program (not on this branch)
